...
namespace GestionDeAulas.Migrations
{
    ...
    [Migration("20241214020140_FixingReserves")]
    partial class FixingReserves
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GestionDeAulas.Models.Classes", b =>
                {
                    b.HasOne("GestionDeAulas.Models.Course", "Course")
                        .WithMany()
                        .HasForeignKey("CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GestionDeAulas.Models.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("GestionDeAulas.Models.Course", b =>
                {
                    b.HasOne("GestionDeAulas.Models.Institutions", "Institution")
                        .WithMany()
